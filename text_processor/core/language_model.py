...
class LanguageModel(ABC):
    ...
    def __init__(self, structured_output=False):
        ...
        :param structured_output: Should be set to True if the model supports
...
class GeminiModel(LanguageModel):
    def __init__(self, api_key: str, model_name="gemini-2.0-flash", structured_output=False):
        """
        ...
        :param structured_output: Whether to enable structured output (not compatible with all models).
        """
...
class OllamaModel(LanguageModel):
    def __init__(self, model_name, ollama_base_url="http://localhost:11434", structured_output=False):
        """

        :param model_name: Model name
        :param ollama_base_url: url for ollama server
        :param structured_output: If the model handles structured output or not
        """
    ...
    def generate_content(self, prompt: str, response_schema: BaseModel=None) -> str:
        """
